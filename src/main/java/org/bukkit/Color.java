...
public final class Color implements ConfigurationSerializable {
    ...
    public static Color fromRGB(int rgb) throws IllegalArgumentException {
        org.apache.commons.lang3.Validate.isTrue((rgb >> 24) == 0, "Extrenuous data in: ", rgb);
    ...
    public static Color fromBGR(int bgr) throws IllegalArgumentException {
        org.apache.commons.lang3.Validate.isTrue((bgr >> 24) == 0, "Extrenuous data in: ", bgr);
        return fromBGR(bgr >> 16 & BIT_MASK, bgr >> 8 & BIT_MASK, bgr >> 0 & BIT_MASK);
    }

    private Color(int red, int green, int blue) {
        org.apache.commons.lang3.Validate.isTrue(red >= 0 && red <= BIT_MASK, "Red is not between 0-255: ", red);
        org.apache.commons.lang3.Validate.isTrue(green >= 0 && green <= BIT_MASK, "Green is not between 0-255: ", green);
        org.apache.commons.lang3.Validate.isTrue(blue >= 0 && blue <= BIT_MASK, "Blue is not between 0-255: ", blue);
    ...
    public Color mixDyes(DyeColor... colors) {
        org.apache.commons.lang3.Validate.noNullElements(colors, "Colors cannot be null");
