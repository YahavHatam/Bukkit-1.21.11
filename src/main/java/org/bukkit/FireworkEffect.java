...
public final class FireworkEffect implements ConfigurationSerializable {
    ...
    public static final class Builder {
        ...
        public Builder with(Type type) throws IllegalArgumentException {
            org.apache.commons.lang3.Validate.notNull(type, "Cannot have null type");
            this.type = type;
            return this;
        }
        ...
        public Builder withColor(Color color) throws IllegalArgumentException {
            org.apache.commons.lang3.Validate.notNull(color, "Cannot have null color");
        ...
        public Builder withColor(Color...colors) throws IllegalArgumentException {
            org.apache.commons.lang3.Validate.notNull(colors, "Cannot have null colors");
            if (colors.length == 0) {
                return this;
            }
            ...
            for (Color color : colors) {
                org.apache.commons.lang3.Validate.notNull(color, "Color cannot be null");
                list.add(color);
            }
