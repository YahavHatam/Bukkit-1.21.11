...
public class Note {
    ...
    public Note(int note) {
        org.apache.commons.lang3.Validate.isTrue(note >= 0 && note <= 24, "The note value has to be between 0 and 24.");
    ...
    public static Note flat(int octave, Tone tone) {
        org.apache.commons.lang3.Validate.isTrue(octave != 2, "Octave cannot be 2 for flats");
    ...
    public static Note natural(int octave, Tone tone) {
        org.apache.commons.lang3.Validate.isTrue(octave != 2, "Octave cannot be 2 for naturals");
     ...
     */
    public Note sharped() {
        org.apache.commons.lang3.Validate.isTrue(note < 24, "This note cannot be sharped because it is the highest known note!");
    ...
    public Note flattened() {
        org.apache.commons.lang3.Validate.isTrue(note > 0, "This note cannot be flattened because it is the lowest known note!");
        return new Note(note - 1);
    }
