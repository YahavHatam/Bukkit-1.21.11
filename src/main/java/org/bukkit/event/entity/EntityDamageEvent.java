...
public class EntityDamageEvent extends EntityEvent implements Cancellable {
    ...
    public EntityDamageEvent(final Entity damagee, final DamageCause cause, final Map<DamageModifier, Double> modifiers, final Map<DamageModifier, ? extends Function<? super Double, Double>> modifierFunctions) {
        super(damagee);
        org.apache.commons.lang3.Validate.isTrue(modifiers.containsKey(DamageModifier.BASE), "BASE DamageModifier missing");
        org.apache.commons.lang3.Validate.isTrue(!modifiers.containsKey(null), "Cannot have null DamageModifier");
        org.apache.commons.lang3.Validate.noNullElements(modifiers.values(), "Cannot have null modifier values");
        org.apache.commons.lang3.Validate.isTrue(modifiers.keySet().equals(modifierFunctions.keySet()), "Must have a modifier function for each DamageModifier");
        org.apache.commons.lang3.Validate.noNullElements(modifierFunctions.values(), "Cannot have null modifier function");
    ...
    public double getDamage(DamageModifier type) throws IllegalArgumentException {
        org.apache.commons.lang3.Validate.notNull(type, "Cannot have null DamageModifier");
