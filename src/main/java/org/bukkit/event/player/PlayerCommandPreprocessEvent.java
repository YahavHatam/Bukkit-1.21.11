...
public class PlayerCommandPreprocessEvent extends PlayerEvent implements Cancellable {
    ...
    public void setMessage(String command) throws IllegalArgumentException {
        org.apache.commons.lang3.Validate.notNull(command, "Command cannot be null");
        org.apache.commons.lang3.Validate.notEmpty(command, "Command cannot be empty");
    ...
    public void setPlayer(final Player player) throws IllegalArgumentException {
        org.apache.commons.lang3.Validate.notNull(player, "Player cannot be null");
        this.player = player;
    }
