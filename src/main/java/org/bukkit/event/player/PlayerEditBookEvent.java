...
public class PlayerEditBookEvent extends PlayerEvent implements Cancellable {
    ...
    public PlayerEditBookEvent(Player who, int slot, BookMeta previousBookMeta, BookMeta newBookMeta, boolean isSigning) {
        ...
        org.apache.commons.lang3.Validate.isTrue(slot >= 0 && slot <=8, "Slot must be in range 0-8 inclusive");
        org.apache.commons.lang3.Validate.notNull(previousBookMeta, "Previous book meta must not be null");
        org.apache.commons.lang3.Validate.notNull(newBookMeta, "New book meta must not be null");
