...
public class Mushroom extends MaterialData {
    ...
    public Mushroom(Material shroom) {
        super(shroom);
        org.apache.commons.lang3.Validate.isTrue(shroom == Material.HUGE_MUSHROOM_1 || shroom == Material.HUGE_MUSHROOM_2, "Not a mushroom!");
    }
    ...
    public Mushroom(int type, byte data){
        super(type, data);
        org.apache.commons.lang3.Validate.isTrue(type == Material.HUGE_MUSHROOM_1.getId() || type == Material.HUGE_MUSHROOM_2.getId(), "Not a mushroom!");
    }
