...
public class Potion {
    ...
    public Potion(PotionType type, Tier tier) {
        ...
        org.apache.commons.lang3.Validate.notNull(type, "Type cannot be null");
    }
    ...
    public Potion(PotionType type, int level) {
        this(type);
        org.apache.commons.lang3.Validate.notNull(type, "Type cannot be null");
        org.apache.commons.lang3.Validate.isTrue(type != PotionType.WATER, "Water bottles don't have a level!");
        org.apache.commons.lang3.Validate.isTrue(level > 0 && level < 3, "Level must be 1 or 2");
        this.level = level;
    }
    ...
    public void apply(ItemStack to) {
        org.apache.commons.lang3.Validate.notNull(to, "itemstack cannot be null");
        org.apache.commons.lang3.Validate.isTrue(to.getType() == Material.POTION, "given itemstack is not a potion");
    ...
    public void apply(LivingEntity to) {
        org.apache.commons.lang3.Validate.notNull(to, "entity cannot be null");
    ...
    public void setHasExtendedDuration(boolean isExtended) {
        org.apache.commons.lang3.Validate.isTrue(type == null || !type.isInstant(), "Instant potions cannot be extended");
        extended = isExtended;
    }
    ...
    public void setTier(Tier tier) {
        org.apache.commons.lang3.Validate.notNull(tier, "tier cannot be null");
    ...
    public void setLevel(int level) {
        org.apache.commons.lang3.Validate.notNull(this.type, "No-effect potions don't have a level.");
        int max = type.getMaxLevel();
        org.apache.commons.lang3.Validate.isTrue(level > 0 && level <= max, "Level must be " + (max == 1 ? "" : "between 1 and ") + max + " for this potion");
        this.level = level;
    }
    ...
    public static Potion fromItemStack(ItemStack item) {
        org.apache.commons.lang3.Validate.notNull(item, "item cannot be null");
