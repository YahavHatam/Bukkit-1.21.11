...
public class StringUtil {
    ...
    public static <T extends Collection<? super String>> T copyPartialMatches(final String token, final Iterable<String> originals, final T collection) throws UnsupportedOperationException, IllegalArgumentException {
        org.apache.commons.lang3.Validate.notNull(token, "Search token cannot be null");
        org.apache.commons.lang3.Validate.notNull(collection, "Collection cannot be null");
        org.apache.commons.lang3.Validate.notNull(originals, "Originals cannot be null");
    ...
    public static boolean startsWithIgnoreCase(final String string, final String prefix) throws IllegalArgumentException, NullPointerException {
        org.apache.commons.lang3.Validate.notNull(string, "Cannot check a null string for a match");
